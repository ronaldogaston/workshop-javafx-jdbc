...
public class ControllerListaDepartamento implements Initializable, AtualizaDadosLista {
	...
	@FXML
	private TableColumn<Departamento, Integer> colunaId; // Tipo Coluna. OBS: Lembrando que só declarar o mesmo não faz
															// com que funcione. Verifique o método 'initialize (URL
															// uri, ResourceBundle rb)'

	@FXML
	private TableColumn<Departamento, Integer> colunaNome; // Tipo Coluna. OBS: Lembrando que só declarar o mesmo não
	...
	public void onBtNewAction(ActionEvent event) { // Ação que ocorrerá após o botão 'Novo' ser clicado -- (ActionEvent
		...
		cadastroDialogoFormulario(dep, "/gui/DepartamentoForm.fxml", parentStage); // Chamada do método de formulário de
																					// cadastro
	}
